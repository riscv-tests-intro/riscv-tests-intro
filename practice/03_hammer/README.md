...
Для формирования списка доработок необходимо освежить знания о подходе, основанном на синхронном сравнении. Он похож на [классический подход сравнения с моделью](../../theory/04_rgen.md#описание-подхода-часть-1), однако имеет свои особенности.
